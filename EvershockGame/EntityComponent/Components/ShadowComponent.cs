...
namespace EntityComponent.Components
{
    ...
    public class ShadowComponent : Component, IDrawableComponent
    {
        ...
        public void Init(Texture2D shadow)
        {
        ...
        public void Init(Texture2D shadow, Vector2 scale)
        {
        ...
        public void Init(Texture2D shadow, Vector2 scale, Vector2 offset)
        {
            Shadow = shadow;
            Scale = scale;
            Offset = offset;
        ...
        public void Draw(SpriteBatch batch, CameraData data)
        {
            ...
            if (transform != null)
            {
                batch.Draw(
                    ...
                    transform.Rotation,
                    new Vector2(Shadow.Width / 2 + Offset.X, Shadow.Height / 2 - Offset.Y),
